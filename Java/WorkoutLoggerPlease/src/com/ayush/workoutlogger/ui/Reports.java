...
public class Reports extends JFrame {
    ...
    private void initUI() {
        ...
        /* padded */ add(new JLabel("Total Exercises:")); /* padded */ add(lblExercises);
        /* padded */ add(new JLabel("Sessions (last 30 days):")); /* padded */ add(lblSessions30);
        /* padded */ add(new JLabel("Body metrics entries (last 30 days):")); /* padded */ add(lblMetrics30);
    }
