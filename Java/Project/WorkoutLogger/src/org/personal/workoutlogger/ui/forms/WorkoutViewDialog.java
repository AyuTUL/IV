...
public class WorkoutViewDialog extends JDialog {
    ...
    public WorkoutViewDialog(Frame owner, Workout workout, WorkoutDaoImpl daoImpl) {
        ...
        getContentPane().setBackground(GlobalUISettings.WINDOW_BG);
    }
    ...
    private void buildUI() {
        ...
        content.setBackground(new Color(220, 223, 228)); // Use global background color
        content.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        content.add(header, BorderLayout.NORTH);
        content.add(tablePane, BorderLayout.CENTER);

        JButton close = GlobalUISettings.createStyledButton("Close");
